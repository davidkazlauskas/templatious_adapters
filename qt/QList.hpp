#ifndef QLIST_34FBVIIT
#define QLIST_34FBVIIT
...
template <class T>
struct CollectionAdapter< QList<T> > {

    static const bool is_valid = true;
    static const bool floating_iterator = true;

	typedef QList<T> ThisCol;
	typedef QList<T> const ConstCol;
...
template <class T>
struct CollectionAdapter< const QList<T> > {

    static const bool is_valid = true;
    static const bool floating_iterator = true;

	typedef QList<T> const ThisCol;
	typedef QList<T> const ConstCol;
...
>
struct CollectionMaker<Val,QList,Alloc> {
    typedef QList<Val> Collection;
...
#endif /* end of include guard: QLIST_34FBVIIT */
